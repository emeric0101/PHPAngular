var nvd3_test_stackArea;
(function (nvd3_test_stackArea) {
    nv.addGraph({
        generate: function () {
            var n = 10, m = 200;
            var data;
        ...
        callback: function (graph) {
            graph.dispatch.on('tooltipShow', function (e) {
                var offsetElement = document.getElementById("chart"), left = e.pos[0] + offsetElement.offsetLeft, top = e.pos[1] + offsetElement.offsetTop, formatterY = d3.format(",.2%"), formatterX = function (d) {
...
})(nvd3_test_stackArea || (nvd3_test_stackArea = {}));
