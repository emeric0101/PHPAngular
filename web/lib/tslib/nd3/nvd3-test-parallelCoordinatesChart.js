var nvd3_test_parallelCoordinatesChart;
(function (nvd3_test_parallelCoordinatesChart) {
    var chart;
    function resetBrush() {
        chart.filters([]);
        chart.active([]);
...
})(nvd3_test_parallelCoordinatesChart || (nvd3_test_parallelCoordinatesChart = {}));
